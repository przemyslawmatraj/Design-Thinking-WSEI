    ...
    <div className={css.overlaySection} ref={ref}>
      <div className={css.overlay}>
        <div
          ...
          style={{
            transform: `scale(${
              divOffset?.y < offsetY - delay && offsetY < divOffset?.y + window.innerHeight * 2
                ? 1 + ((offsetY - delay - divOffset?.y) / (window.innerHeight * 2)) * 250
                : offsetY > divOffset?.y + window.innerHeight * 2
                ? 250
                : 1
            })`,
          }}
