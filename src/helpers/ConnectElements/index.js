...
// I added a few changes for my purpose

// Source: https://www.npmjs.com/package/react-connect-elements
...
export default class ReactConnectElements extends PureComponent {
  ...
  checkSelector = () => {
    if (document.querySelector(this.props.selector)) {
      this.setState({ querySelector: this.props.selector }, () => this.connectAll());
    }
  };
